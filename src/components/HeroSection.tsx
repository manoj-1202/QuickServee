        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-1.5 xs:gap-2 px-3 xs:px-4 py-1.5 xs:py-2 bg-accent rounded-full mb-4 xs:mb-6"
            >
            ...
            {/* Headline */}
            <h1 className="font-display text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-4 xs:mb-6">
              {BUSINESS.name} –{" "}
          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                className="absolute -top-6 xl:-top-8 -right-6 xl:-right-8 bg-card rounded-xl xl:rounded-2xl shadow-lg p-3 xl:p-4 border border-border"
              >
              ...
              <motion.div
                ...
                className="absolute -bottom-6 xl:-bottom-8 -left-6 xl:-left-8 bg-card rounded-xl xl:rounded-2xl shadow-lg p-3 xl:p-4 border border-border"
              >
                <div className="flex items-center gap-2 xl:gap-3">
